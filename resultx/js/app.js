(() => {
    ...
    function addFixedHeader() {
        ...
        function fixHeader() {
            ...
            if (currentScroll <= 0) body.classList.remove("_scroll-up");
            if (currentScroll <= header.clientHeight) header.classList.add("_header-default"); else header.classList.remove("_header-default");
